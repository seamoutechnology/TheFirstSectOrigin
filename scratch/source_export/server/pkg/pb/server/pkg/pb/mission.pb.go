...
type CheckInDailyRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CheckInDailyRequest) Reset() {
	*x = CheckInDailyRequest{}
	mi := &file_mission_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CheckInDailyRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckInDailyRequest) ProtoMessage() {}

func (x *CheckInDailyRequest) ProtoReflect() protoreflect.Message {
	mi := &file_mission_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckInDailyRequest.ProtoReflect.Descriptor instead.
func (*CheckInDailyRequest) Descriptor() ([]byte, []int) {
	return file_mission_proto_rawDescGZIP(), []int{5}
}

type CheckInDailyResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Code          int32                  `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	MessageId     string                 `protobuf:"bytes,2,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *CheckInDailyResponse) Reset() {
	*x = CheckInDailyResponse{}
	mi := &file_mission_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CheckInDailyResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckInDailyResponse) ProtoMessage() {}

func (x *CheckInDailyResponse) ProtoReflect() protoreflect.Message {
	mi := &file_mission_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckInDailyResponse.ProtoReflect.Descriptor instead.
func (*CheckInDailyResponse) Descriptor() ([]byte, []int) {
	return file_mission_proto_rawDescGZIP(), []int{6}
}

func (x *CheckInDailyResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *CheckInDailyResponse) GetMessageId() string {
	if x != nil {
		return x.MessageId
	}
	return ""
...
func (x *ClaimMissionRewardRequest) GetMissionId() int32 {
	if x != nil {
		return x.MissionId
	}
	return 0
...
func (x *ClaimMissionRewardResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ClaimMissionRewardResponse) GetMessageId() string {
	if x != nil {
		return x.MessageId
	}
	return ""
...
const file_mission_proto_rawDesc = "" +
	...
	"\x13CheckInDailyRequest\"I\n" +
	"\x14CheckInDailyResponse\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x1d\n" +
	"\n" +
	"message_id\x18\x02 \x01(\tR\tmessageId\":\n" +
	"\x19ClaimMissionRewardRequest\x12\x1d\n" +
	"\n" +
	"mission_id\x18\x01 \x01(\x05R\tmissionId\"O\n" +
	"\x1aClaimMissionRewardResponse\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x1d\n" +
	"\n" +
...
var file_mission_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_mission_proto_goTypes = []any{
	...
	(*CheckInDailyRequest)(nil),        // 7: pb.CheckInDailyRequest
	(*CheckInDailyResponse)(nil),       // 8: pb.CheckInDailyResponse
	(*ClaimMissionRewardRequest)(nil),  // 9: pb.ClaimMissionRewardRequest
	(*ClaimMissionRewardResponse)(nil), // 10: pb.ClaimMissionRewardResponse
	nil,                                // 11: pb.Mission.RewardsEntry
	nil,                                // 12: pb.CompleteMissionResponse.RewardsEntry
}
var file_mission_proto_depIdxs = []int32{
	...
	11, // 2: pb.Mission.rewards:type_name -> pb.Mission.RewardsEntry
	0,  // 3: pb.GetMissionsRequest.filter_type:type_name -> pb.MissionType
	2,  // 4: pb.GetMissionsResponse.missions:type_name -> pb.Mission
	12, // 5: pb.CompleteMissionResponse.rewards:type_name -> pb.CompleteMissionResponse.RewardsEntry
