    ...
    public class CameraController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (_cam != null)
            {
                ...
                {
                    float centerX = BaseGridManager.Instance.Width / 2f;
                    float centerY = BaseGridManager.Instance.Height / 2f;
        ...
        public float CurrentZoom => _cam != null ? _cam.orthographicSize : defaultZoom;

        public void FocusZoom(float targetZoom, float duration = 0.5f)
        {
            if (_cam != null)
            {
