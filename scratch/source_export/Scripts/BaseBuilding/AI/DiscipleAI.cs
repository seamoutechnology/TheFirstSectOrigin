...
namespace GameClient.BaseBuilding.AI
{
        ...
        public void PlayAnimation(string animName)
        {
            ...
            switch (animName.ToLower())
            {
                case "idle":
                    ...
                    transform.DOScaleY(_originalScale.y * 1.05f, 1f).SetLoops(-1, LoopType.Yoyo).SetEase(Ease.InOutSine);
                    transform.DOScaleX(_originalScale.x * 0.96f, 1f).SetLoops(-1, LoopType.Yoyo).SetEase(Ease.InOutSine);
                    break;
                ...
                case "run":
                    ...
                    transform.DOScaleY(_originalScale.y * 0.92f, 0.2f).SetLoops(-1, LoopType.Yoyo).SetEase(Ease.InOutQuad);
                    break;
                ...
                case "meditate":
                    ...
                    transform.DOScale(_originalScale * 0.9f, 2f).SetLoops(-1, LoopType.Yoyo).SetEase(Ease.InOutQuad);
                ...
                case "combatidle":
                    ...
                    transform.DOScaleY(_originalScale.y * 1.08f, 0.5f).SetLoops(-1, LoopType.Yoyo).SetEase(Ease.InOutSine);
                    transform.DOScaleX(_originalScale.x * 0.92f, 0.5f).SetLoops(-1, LoopType.Yoyo).SetEase(Ease.InOutSine);
                    break;
                ...
                case "skill2":
                    ...
                    Vector3 moveDir = (sr != null && sr.flipX) ? Vector3.left : Vector3.right;
    ...
    public class MoveState : BaseState
    {
        ...
        public override void Enter()
        {
            ...
            var sr = _ai.GetComponentInChildren<SpriteRenderer>();
            if (sr != null)
            {
                sr.flipX = _ai.TargetPosition.x < _ai.transform.position.x;
            }
