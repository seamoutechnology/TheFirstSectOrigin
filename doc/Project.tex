\documentclass[a4paper,12pt,3p,oneside,openany]{report}
\usepackage{scrextend}
\changefontsizes{12pt}
\usepackage[utf8]{vietnam}
\usepackage[top=2cm, bottom=2cm, left=3.0cm, right=2.0cm]{geometry}
...
\usepackage{microtype} % Tối ưu khoảng cách giữa các chữ, tránh chữ bị giãn cách không đều
...
\usepackage{times} % Chọn font Time New Romans tròn trịa theo ý người dùng
...
\usepackage{setspace}
\linespread{1.3} % Dãn dòng 1.3 chuẩn luận văn
% Bỏ parskip để đoạn văn thụt lề chuẩn
...
\subfile{FrontCover} % Phần bìa
\subfile{BackCover} % Phần bìa
% \restoregeometry
...
\subfile{Chapter/0_2_Acknowledgement.tex}
...
\subfile{Chapter/0_5_Abbreviations.tex}



\newpage
\subfile{Chapter/0_6_Glossary.tex}
% ===================================================
...
\subfile{Chapter/2_Requirement_Analysis}
