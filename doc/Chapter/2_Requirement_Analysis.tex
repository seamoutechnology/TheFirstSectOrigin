...
\begin{tikzpicture}[node distance=1.5cm, every node/.style={fill=white}]
  ...
  % Use Cases
  \node[draw, ellipse, minimum width=4cm, minimum height=1cm, align=center] (uc1) at (6, 1.5) {Đăng nhập hệ thống};
  \node[draw, ellipse, minimum width=4cm, minimum height=1cm, align=center] (uc2) at (6, 0.5) {Quản lý tông môn};
  \node[draw, ellipse, minimum width=4cm, minimum height=1cm, align=center] (uc3) at (6, -0.5) {Quản lý đệ tử};
  \node[draw, ellipse, minimum width=4cm, minimum height=1cm, align=center] (uc4) at (6, -1.5) {Vượt ải chiến dịch};
  \node[draw, ellipse, minimum width=4cm, minimum height=1cm, align=center] (uc5) at (6, -2.5) {Xem bảng xếp hạng};
