...
\begin{itemize}
    ...
    \item \textbf{Tiền điều kiện}: Người chơi đã đăng nhập, sở hữu đủ tài nguyên (Gỗ, Đá, Vàng (Item ID: 00001)) và đạt yêu cầu cấp độ tông môn tối thiểu.
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Nếu người chơi thắng, World-server cập nhật tiến trình vượt ải mới nhất và cộng phần thưởng (Vàng (Item ID: 00001), vật phẩm) vào tài khoản người chơi trong PostgreSQL.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Đảm bảo tính nhất quán giao dịch tuyệt đối đối với các hành động khấu trừ tài nguyên (Gỗ, Đá, Vàng (Item ID: 00001)) và trao thưởng vật phẩm, loại bỏ hoàn toàn khả năng xảy ra lỗi trùng lặp giao dịch (double-spending).
    \end{itemize}
