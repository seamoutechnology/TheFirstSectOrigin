...
\begin{itemize}
    ...
    \item \textbf{Tác nhân}: Người chơi.
    \item \textbf{Tiền điều kiện}: Người chơi đã đăng nhập, tông môn sở hữu các công trình sản xuất tài nguyên nhàn rỗi (như Nhà Gỗ, Mỏ Đá, Vàng (Item ID: 00001) Khoáng) và các công trình này đã tích lũy được lượng sản lượng lớn hơn 0 kể từ lần thu hoạch trước.
    \item \textbf{Hậu điều kiện}: Lượng tài nguyên nhàn rỗi tích lũy trong các công trình được chuyển vào ví tài sản của người chơi (Gỗ, Đá, Vàng (Item ID: 00001)), trạng thái tích lũy của công trình được đưa về 0.
    \item \textbf{Luồng sự kiện chính}:
    \begin{enumerate}
        ...
        \item Dịch vụ World cập nhật lượng tài nguyên tích lũy của công trình về 0 và cộng lượng tài nguyên đã thu hoạch vào tổng số dư tài sản (Gỗ, Đá, Vàng (Item ID: 00001)) của người chơi trong cơ sở dữ liệu PostgreSQL.
